...
Direct execution script for data retrieval and orchestration

This script runs queries directly with a query defined in the QUERY variable below.
Simply modify the QUERY variable and run: python api_main_direct.py
"""
import asyncio
import os
import re
...
# ============================================================================
# QUERY VARIABLE - Define your query here to run the script directly
# ============================================================================
QUERY = """
This research will examine the state of poverty in India through key dimensions including real household consumption patterns, employment trends and wage dynamics, educational attainment and school attendance rates, access to basic amenities, demographic and social characteristics, health indicators and out-of-pocket healthcare expenditures, and ownership of household assets for the period 2022-23 to 2023-24.
It is a contemporary study. The scope will explore:

What are the current trends in real household consumption patterns across different states and UTs?
How have employment rates and wage dynamics evolved during this period?
What are the current levels of educational attainment and school attendance rates among various social groups?
What access do households have to basic amenities such as water, housing, sanitation, and electricity?
How do demographic and social characteristics impact poverty levels across regions?
What health indicators reflect the current state of poverty, including out-of-pocket healthcare expenditures?
What is the current status of household asset ownership among the poor?
What do these combined trends reveal about shifts in the number of poor across states and UTs, social groups, and rural and urban regions?
This research will provide a comprehensive understanding of the multidimensional aspects of poverty in India during the specified timeframe.
"""
#QUERY = "GDP since 2024"
#QUERY = "Quarterly IIP of mining sector for the last 6 months4"
#QUERY = "Monthly GDP since 2024"
# ============================================================================
...
async def execute_query(user_query: str):
    """
    Execute a query directly and return the result.
    This is the core logic extracted from the orchestrate function.
    
    Args:
        user_query: The query string to execute
        
    Returns:
        dict: The response dictionary with success, data, and token counts
    """
...
async def main():
    """
    Main function to run the query directly when executing the script.
    Uses the QUERY variable defined at the top of the file.
    """
    print("=" * 80)
    print("Direct Query Execution")
    print("=" * 80)
    print(f"Query: {QUERY}")
    print("=" * 80)
    print()
    ...
    print(f"Total Time: {result.get('data', {}).get('total_time', 'N/A')} seconds")
    ...
    if result.get('success'):
        ...
        print("-" * 80)
        print(data.get('suggested_answer', 'N/A'))
        print()
        print("Context:")
        print("-" * 80)
        ...
        print(f"Error context: {result.get('data', {}).get('context', 'N/A')}")
    
    print()
    print("=" * 80)
    print("Token Usage:")
    print(f"  Input tokens: {result.get('total_input_tokens', {})}")
    print(f"  Output tokens: {result.get('total_output_tokens', {})}")
    print("=" * 80)
